function [ data_struct ] = extract_all_periods_gaus(data_struct, thres, Fs,std_dev, step_size, nms_size)
...
for i = 1:num_ppl
    ...
    for j = 1:num_trials
        [period,steps] = extract_period_gaus(data_struct.dataProj{i}{j},...
            thres, Fs,std_dev, step_size, nms_size, 0);
